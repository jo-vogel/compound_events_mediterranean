...
import os 
os.getcwd()
os.chdir('D:/Local/Data/ERA5/Precipitation/1979-1989')

# Note that the first month has "080000" at its end, because it starts at 8 am, not 0 am
...
#d = datetime.strptime(str(day[0]), '%Y%m%d%H%M%S')

#f_in = 'tp_%d-%s.nc' % (day[0], (d + timedelta(days = 4018-1)).strftime('%Y%m%d')) # 11 Years including 3 leap years
f_in = 'Monthly_precipitation_1979-1989.nc' # Load input file: precipitation for 11 Years including 3 leap years
#for j in day:
